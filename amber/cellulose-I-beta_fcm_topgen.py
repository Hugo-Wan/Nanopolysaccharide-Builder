...
structure_input_file = 'glycam06-cellulose-Ibeta-18fcm.pdb'
...
def generate_tleap_combine_command(num_glycans):
    ...
    output_lines.extend([
        "\nsolvatebox combined_glycan TIP3PBOX 12.0",
        "\ncheck combined_glycan",
        "\naddions combined_glycan Cl- 5",
        "\naddions combined_glycan Na+ 5",
