...
chain_1 = os.path.join(main_folder_path, 'structure', 'cellulose_II', 'glycam06', 'chain-1-finite.pdb')
chain_2 = os.path.join(main_folder_path, 'structure', 'cellulose_II', 'glycam06', 'chain-2-finite.pdb')
