...
neutron_pdb = os.path.join(main_folder_path, 'structure', 'beta_chitin', 'charmm36', 'dihydrous-unit.pdb')
user_defined_pdb = os.path.join(main_folder_path, 'structure', 'beta_chitin', 'charmm36', 'dihydrous-unit-ud.pdb')
...
box_x = (a_iterations+3) * a_trans + 40
box_y = (b_iterations+1) * b_trans + 20
...
with mda.Writer("charmm36-beta-chitin-para-dihydrous-fcm.pdb", n_atoms=u_final.atoms.n_atoms, reindex=True) as W:
