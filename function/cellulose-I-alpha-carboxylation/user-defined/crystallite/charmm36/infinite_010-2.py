...
if carboxylation_num > 0:
    ...
    all_indices = [left_010_coo_candidates_indices, right_010_coo_candidates_indices]
...
#    ####------------------------------------------------------------coo_ph building step----------------------------------------------------------------
    ...
    coo_netural_indices_groups = [left_010_coo_netural_candidates_indices, right_010_coo_netural_candidates_indices]
