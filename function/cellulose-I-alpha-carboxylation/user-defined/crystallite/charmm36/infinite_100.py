...
if carboxylation_num > 0:
    ...
    left_100_count=carboxylation_num
    ...
    new_carboxylation_number_update= left_100_count_update  
    ...
    all_indices = [left_100_coo_candidates_indices, right_100_coo_candidates_indices]
...
#    ####------------------------------------------------------------coo_ph building step----------------------------------------------------------------
    ...
    right_100_coo_netural_candidates_indices = get_fragment_indices(coo_deprotonation_chains, sel_100_left_array)  
    

    coo_netural_indices_groups = [left_100_coo_netural_candidates_indices, right_100_coo_netural_candidates_indices]
