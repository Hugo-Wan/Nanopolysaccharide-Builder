...
if carboxylation_num > 0:
    ...
    max_100_count_left = c_iterations * len(planes_100_left)
    max_100_count_right = c_iterations * len(planes_100_right)
    ...
    upper_coo_candidates_indices  = get_fragment_indices(primary_hydroxyl_remove_chains, sel_100_left_array)   
    bottom_coo_candidates_indices = get_fragment_indices(primary_hydroxyl_remove_chains, sel_100_right_array)  
