...
if carboxylation_num > 0:
    ...
    new_carboxylation_number_update=upper_100_count_update + bottom_100_count_update  
    ...
    all_indices = [upper_glc_100_candidates_indices, bottom_glc_100_candidates_indices]
