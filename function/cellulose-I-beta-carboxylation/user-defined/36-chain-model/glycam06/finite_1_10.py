...
planes_1_10_count=len(planes_1_10_left)
...
if carboxylation_num > 0:
    left_1_10_count=carboxylation_num
    ...
    new_carboxylation_number_update= left_1_10_count_update 
    ...
    all_indices = [left_glc_1_10_candidates_indices]
        ...
        for index_ranges in indices_lists:
            for start_idx, end_idx in index_ranges:
                ...
                for residue in residues:
                    ...
                    if residue.resid % 2 == 0  and fragment_number in planes_1_10_left:  # Odd residue ID
                        coo_new_positions = {
