...
m_difference=111                # difference between Glc unit with Glc-cooNa(3) 111 represents the molar mass difference of 2,3,6-tricarboxycellulose and anhydrousglucose unit
                                # reference: https://doi.org/10.1016/j.carbpol.2019.115292
...
def adjust_for_carboxylation_limit(initial_carboxylation_num):
    ...
    carboxylation_number_limit = c_iterations * planes_110_count +  c_iterations * planes_1_10_count
...
#    ####------------------------------------------------------------coo_ph building step----------------------------------------------------------------
    ...
    with mda.Writer(f"charmm36-cellulose-Ibeta-18icm.pdb", n_atoms=u_final.atoms.n_atoms, reindex=True, ) as W:
