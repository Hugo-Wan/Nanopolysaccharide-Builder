...
if carboxylation_num > 0:
    ...
    new_carboxylation_number_update=left_110_count_update + left_1_10_count_update
    ...
    all_indices = [left_glc_110_candidates_indices, 
                   left_glc_1_10_candidates_indices]
