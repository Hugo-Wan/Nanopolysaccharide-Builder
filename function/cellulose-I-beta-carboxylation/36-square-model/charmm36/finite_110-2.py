...
planes_110_left    = [0,  6,  16 ,23, 28,34]
planes_1_10_left   = [10, 18, 31, 35, 14]
planes_1_10_right  = [9,  17, 27, 30, 34]
planes_110_right   = [5,  13, 15, 22, 33, 35]
...
if carboxylation_num > 0:
    ...
    all_combinations_110_left  = [(value1, value2) for value1 in planes_110_left for value2 in odd_numbers_110 ]
    all_combinations_110_right = [(value1, value2) for value1 in planes_110_right  for value2 in even_numbers_110 ]
        ...
        for index_ranges in indices_lists:
            for start_idx, end_idx in index_ranges:
                ...
                for residue in residues:
                    ...
                    coo_new_positions = {} 
                    if  fragment_number in planes_110_left:  # Odd residue ID
                        coo_new_positions = {
                            'O61': base_atom.position + np.array([ 1.429,   0.063,   0.0129]),
                            'O62': base_atom.position + np.array([-0.659,  -1.241,  -0.2640])
                        }
    
                    elif  fragment_number in planes_110_right:  # Even residue ID
                        coo_new_positions = {
...
#    ####------------------------------------------------------------coo_ph building step----------------------------------------------------------------
    ...
    left_coo_netural_candidates_indices   = get_fragment_indices(coo_deprotonation_chains, sel_110_left_array)    
    right_coo_netural_candidates_indices  = get_fragment_indices(coo_deprotonation_chains, sel_110_right_array)     
