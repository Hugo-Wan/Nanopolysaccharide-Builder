...
#    ####------------------------------------------------------------coo_ph building step----------------------------------------------------------------
    ...
    right_coo_netural_candidates_indices  = get_fragment_indices(coo_deprotonation_chains, sel_right_array)   
    upper_coo_netural_candidates_indices  = get_fragment_indices(coo_deprotonation_chains, sel_110_upper_array)   
    bottom_coo_netural_candidates_indices = get_fragment_indices(coo_deprotonation_chains, sel_110_bottom_array)  
