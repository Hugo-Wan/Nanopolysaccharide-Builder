...
###center-upper-right
step_3_move_vertical_coef= 3* a_trans   + 3 * b_trans * sinA
...
###center-upper-left
step_5_move_vertical_coef= 3 * a_trans  - 3 * b_trans * sinA
...
with mda.Writer("glycam06-c1b-4-bundles-icm.pdb", n_atoms=u_combined.atoms.n_atoms, reindex=True) as W:
