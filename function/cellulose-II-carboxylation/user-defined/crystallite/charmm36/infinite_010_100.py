...
if carboxylation_num > 0:
    ...
    new_carboxylation_number_update=bottom_010_count_update + left_100_count_update
    ...
    all_indices = [left_glc_100_candidates_indices, bottom_glc_010_candidates_indices]
    ...
    all_indices = [left_coo_candidates_indices,  bottom_coo_candidates_indices]
...
#    ####------------------------------------------------------------coo_ph building step----------------------------------------------------------------
    ...
    coo_netural_indices_groups = [left_coo_netural_candidates_indices, bottom_coo_netural_candidates_indices]
