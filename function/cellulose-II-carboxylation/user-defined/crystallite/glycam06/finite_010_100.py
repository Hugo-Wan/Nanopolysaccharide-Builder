...
neutron_pdb_1 = os.path.join(main_folder_path, 'structure', 'cellulose_II', 'glycam06', 'chain-1-finite.pdb')
user_defined_pdb_1 = os.path.join(main_folder_path, 'structure', 'cellulose_II', 'glycam06', 'chain-1-finite_ud.pdb')
...
neutron_pdb_2 = os.path.join(main_folder_path, 'structure', 'cellulose_II', 'glycam06', 'chain-2-finite.pdb')
user_defined_pdb_2 = os.path.join(main_folder_path, 'structure', 'cellulose_II', 'glycam06', 'chain-2-finite_ud.pdb')
