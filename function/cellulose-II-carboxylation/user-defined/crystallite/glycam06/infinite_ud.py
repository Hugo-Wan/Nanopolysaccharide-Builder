...
neutron_pdb_1 = os.path.join(main_folder_path, 'structure', 'cellulose_II', 'glycam06', 'chain-1.pdb')
user_defined_pdb_1 = os.path.join(main_folder_path, 'structure', 'cellulose_II', 'glycam06', 'chain-1_ud.pdb')
...
neutron_pdb_2 = os.path.join(main_folder_path, 'structure', 'cellulose_II', 'glycam06', 'chain-2.pdb')
user_defined_pdb_2 = os.path.join(main_folder_path, 'structure', 'cellulose_II', 'glycam06', 'chain-2_ud.pdb')
...
if carboxylation_num > 0:
    ...
    with mda.Writer(f"glycam06-cellulose-II-icm.pdb", n_atoms=u_final.atoms.n_atoms, reindex=True, ) as W:
    ...
    translation_vector = center_of_box - center_of_mass
    u_final.atoms.translate(translation_vector)
    with mda.Writer("glycam06-cellulose-II-icm.pdb", n_atoms=u_final.atoms.n_atoms, reindex=True) as W:
        W.write(u_final.atoms)
