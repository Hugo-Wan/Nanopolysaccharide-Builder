...
box_z = a_iterations * a_trans + 30
box_y = c_iterations * c_trans + 30
...
with mda.Writer("charmm36-cellulose-Ialpha-fcm.pdb", n_atoms=u_final.atoms.n_atoms, reindex=True) as W:
