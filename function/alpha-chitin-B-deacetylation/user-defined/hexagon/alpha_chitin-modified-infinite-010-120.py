...
neutron_pdb_1 = os.path.join(main_folder_path, 'structure', 'alpha_chitin', 'charmm36', 'B_configuration', 'left-unit.pdb')
user_defined_pdb_1 = os.path.join(main_folder_path, 'structure', 'alpha_chitin', 'charmm36', 'B_configuration', 'left-unit_ud.pdb')
...
neutron_pdb_2 = os.path.join(main_folder_path, 'structure', 'alpha_chitin', 'charmm36', 'B_configuration', 'right-unit.pdb')
user_defined_pdb_2 = os.path.join(main_folder_path, 'structure', 'alpha_chitin', 'charmm36', 'B_configuration', 'right-unit_ud.pdb')
...
planes_010_count=(planes_010_left[-1] - planes_010_left[0] + 1)
planes_120_count=len(planes_120_upper)
...
if aminiation_number > 0:
    every_plane_even_count = int(aminiation_number / 2)
    #random_distribute_part = aminiation_number - every_plane_even_count * 4
    new_aminiation_number=every_plane_even_count*2
    planes_010_even_count = every_plane_even_count 
    planes_120_even_count = every_plane_even_count
    if planes_010_even_count > c_iterations * planes_010_count:
        planes_010_even_new_count = (c_iterations * planes_010_count)
        planes_120_even_new_count = (new_aminiation_number - planes_010_even_new_count)
        if planes_120_even_new_count > planes_120_count*2*c_iterations:
            planes_120_even_new_count= planes_120_count*2*c_iterations
    else:
        planes_010_even_new_count= planes_010_even_count
        planes_120_even_new_count= planes_120_even_count
        if planes_120_even_new_count > planes_120_count*2*c_iterations:
           planes_120_even_new_count = planes_120_count*2*c_iterations
           planes_010_even_new_count = new_aminiation_number - planes_120_even_new_count
           if planes_010_even_count > c_iterations * planes_010_count:
            planes_010_even_new_count = (c_iterations * planes_010_count)
    
    #print(planes_010_count)
    
    new_aminiation_number_update=planes_120_even_new_count*2 + planes_010_even_new_count*2
    ...
    while len(sel_010_left_array) < planes_010_even_new_count:
    ...
    while len(sel_120_upper_array) < planes_120_even_new_count:
    ...
    with mda.Writer(f"charmm36-alpha-chitin-B-hexagon-icm.pdb", n_atoms=u_final.atoms.n_atoms, reindex=True, ) as W:
