...
if aminiation_number > 0:
    ...
    if planes_010_even_count > c_iterations * planes_010_count/2:
        planes_010_even_new_count = (c_iterations * planes_010_count)/2
    else:
        planes_010_even_new_count= planes_010_even_count

    #print(planes_010_count)
    
    new_aminiation_number_update=planes_010_even_new_count*2
    ...
    while len(sel_010_right_array) < planes_010_even_new_count:
    ...
    all_indices = [left_nh3_candidates_indices, right_nh3_candidates_indices]
    ...
    ##apply nh2 remove
    nh2_indices_groups = [left_nh2_candidates_indices, right_nh2_candidates_indices]
