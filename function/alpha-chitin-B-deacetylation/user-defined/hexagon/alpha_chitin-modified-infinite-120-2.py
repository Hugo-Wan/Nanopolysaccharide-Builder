...
if aminiation_number > 0:
    ...
    planes_120_even_new_count=planes_010_even_count
    if planes_120_even_new_count > planes_120_count*c_iterations:   ###120_count includes upper and bottom planes, so it involves 2
       planes_120_even_new_count= planes_120_count*c_iterations
    else:
       planes_120_even_new_count= every_plane_even_count
   
    
    #print(planes_010_count)
    
    new_aminiation_number_update=planes_120_even_new_count*2 
    ...
    while len(sel_120_bottom_array) < planes_120_even_new_count:
