...
if aminiation_number > 0:
    ...
    if planes_120_even_new_count > planes_120_count*c_iterations*2:
        planes_120_even_new_count= planes_120_count*c_iterations*2
    else:
        planes_120_even_new_count= every_plane_even_count

    
    #print(planes_010_count)
    new_aminiation_number_update=planes_120_even_new_count
    ...
    all_indices = [upper_nh3_candidates_indices]
    ...
    ##apply nh2 remove
    nh2_indices_groups = [upper_nh2_candidates_indices]
