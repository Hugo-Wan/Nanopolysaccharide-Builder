...
def adjust_for_amination_limit(closest_x, total_residues):
    ...
    amination_number_limit=c_iterations*planes_010_count 
...
if aminiation_number > 0:
    every_plane_even_count = int(aminiation_number)
    #random_distribute_part = aminiation_number - every_plane_even_count * 4
    new_aminiation_number=every_plane_even_count
    ...
    new_aminiation_number_update=planes_010_even_new_count
        ...
        for index_ranges in indices_lists:
            for start_idx, end_idx in index_ranges:
                ...
                for residue in residues:
                    ...
                    if fragment_number in range(min(planes_010_left), max(planes_010_left)+1):  # Odd residue ID
                        nh3_new_positions = {
    ...
    all_indices = [left_nh3_candidates_indices]
    ...
    ##apply nh2 remove
    nh2_indices_groups = [left_nh2_candidates_indices]
