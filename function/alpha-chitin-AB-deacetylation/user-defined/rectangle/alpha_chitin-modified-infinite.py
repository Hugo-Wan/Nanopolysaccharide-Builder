...
print("(100) modified count", planes_100_count)
...
#print("aminiation umber is :", aminiation_number )
#
...
if aminiation_number > 0:
    ...
    print(left_010_count, right_010_count,upper_100_count,bottom_100_count  )
    
    new_aminiation_number=aminiation_number
    #print("update aminiation number is :", new_aminiation_number)
    ...
    #print("100 upper update is :", planes_100_upper_count)
    #print("100 bottom update is :", planes_100_bottom_count)
    ...
    #print(upper_100_count_update, max_100_count_upper)
    if bottom_100_count > max_100_count_bottom:
        bottom_100_count_update = max_100_count_bottom    
    #print(bottom_100_count_update, max_100_count_bottom)    
    ...
    with mda.Writer(f"charmm36-alpha-chitin-AB-icm.pdb", n_atoms=u_final.atoms.n_atoms, reindex=True, ) as W:
