...
if aminiation_number > 0:
    ...
    with mda.Writer(f"charmm36-alpha-chitin-AB-hexagon-icm.pdb", n_atoms=u_final.atoms.n_atoms, reindex=True, ) as W:
    ...
    u_final.dimensions = [box_x, box_y, box_z, 90, 90, 90]
    translation_vector = center_of_box - center_of_mass
    with mda.Writer(f"charmm36-alpha-chitin-AB-hexagon-ocm.pdb", n_atoms=u_final.atoms.n_atoms, reindex=True, ) as W:
        W.write(u_final.atoms)
