...
user_defined_pdb_1 = os.path.join(main_folder_path, 'structure', 'alpha_chitin', 'charmm36', 'A_configuration', 'left-unit-finite.pdb')
...
user_defined_pdb_2 = os.path.join(main_folder_path, 'structure', 'alpha_chitin', 'charmm36', 'A_configuration', 'right-unit-finite.pdb')
...
with mda.Writer("charmm36-alpha-chitin-A-hexagon-icm.pdb", n_atoms=final_structure.atoms.n_atoms, reindex=True) as W:
