...
neutron_pdb_1 = os.path.join(main_folder_path, 'structure', 'alpha_chitin', 'glycam06', 'A_configuration', 'left-unit.pdb')
user_defined_pdb_1 = os.path.join(main_folder_path, 'structure', 'alpha_chitin', 'glycam06', 'A_configuration', 'left-unit_ud.pdb')
...
neutron_pdb_2 = os.path.join(main_folder_path, 'structure', 'alpha_chitin', 'glycam06', 'A_configuration', 'right-unit.pdb')
user_defined_pdb_2 = os.path.join(main_folder_path, 'structure', 'alpha_chitin', 'glycam06', 'A_configuration', 'right-unit_ud.pdb')
...
with mda.Writer("glycam06-alpha-chitin-A-hexagon-icm.pdb", n_atoms=final_structure.atoms.n_atoms, reindex=True) as W:
