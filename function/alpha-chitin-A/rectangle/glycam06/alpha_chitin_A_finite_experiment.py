...
left_chain_input_file = os.path.join(main_folder_path, 'structure', 'alpha_chitin', 'glycam06', 'A_configuration', 'left-unit-finite.pdb')
right_chain_input_file = os.path.join(main_folder_path, 'structure', 'alpha_chitin', 'glycam06', 'A_configuration', 'right-unit-finite.pdb')
...
with mda.Writer("glycam06-alpha-chitin-A-fcm.pdb", n_atoms=u_final.atoms.n_atoms, reindex=True) as W:
