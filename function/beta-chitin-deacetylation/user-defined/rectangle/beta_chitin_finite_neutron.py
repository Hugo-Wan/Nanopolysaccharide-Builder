...
new_positions = {
    'O1': unit_first_atom.position + [-0.500, -0.400, 1.200],
    'HO1': unit_first_atom.position + [0.129, -0.365, 1.932],
    'HO4': last_o4.position + [0.367, -0.182, -0.882]
}
...
if aminiation_number > 0:
    ...
    new_aminiation_number_update=upper_100_count_update + bottom_100_count_update + left_010_count_update + right_010_count_update 
