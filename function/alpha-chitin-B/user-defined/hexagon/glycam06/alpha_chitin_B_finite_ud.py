...
neutron_pdb_1 = os.path.join(main_folder_path, 'structure', 'alpha_chitin', 'glycam06', 'B_configuration', 'left-unit-finite.pdb')
user_defined_pdb_1 = os.path.join(main_folder_path, 'structure', 'alpha_chitin', 'glycam06', 'B_configuration', 'left-unit-finite_ud.pdb')
...
neutron_pdb_2 = os.path.join(main_folder_path, 'structure', 'alpha_chitin', 'glycam06','B_configuration', 'right-unit-finite.pdb')
user_defined_pdb_2 = os.path.join(main_folder_path, 'structure', 'alpha_chitin', 'glycam06', 'B_configuration', 'right-unit-finite_ud.pdb')
...
with mda.Writer("glycam06-alpha-chitin-B-hexagon-fcm.pdb", n_atoms=final_structure.atoms.n_atoms, reindex=True) as W:
