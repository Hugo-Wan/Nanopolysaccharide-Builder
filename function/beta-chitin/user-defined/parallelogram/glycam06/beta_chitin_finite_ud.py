...
xray_pdb = os.path.join(main_folder_path, 'structure', 'beta_chitin', 'glycam06', 'unit-xray-finite.pdb')
user_defined_pdb = os.path.join(main_folder_path, 'structure', 'beta_chitin', 'glycam06', 'unit-xray-ud-finite.pdb')
