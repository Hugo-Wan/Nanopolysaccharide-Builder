...
xray_pdb = os.path.join(main_folder_path, 'structure', 'beta_chitin', 'glycam06', 'unit-neutron.pdb')
...
with mda.Writer("glycam06-beta-chitin-para-icm.pdb", n_atoms=u_final.atoms.n_atoms, reindex=True) as W:
