...
xray_pdb = os.path.join(main_folder_path, 'structure', 'beta_chitin', 'glycam06', 'unit-xray.pdb')
user_defined_pdb = os.path.join(main_folder_path, 'structure', 'beta_chitin', 'glycam06', 'unit-xray-ud.pdb')
