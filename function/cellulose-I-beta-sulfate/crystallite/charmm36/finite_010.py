...
if sulfate_num > 0:
    ...
    new_sulfate_number_update= left_010_count_update  
    ...
    all_indices = [left_glc_010_candidates_indices]
    ...
    all_indices = [left_so3_candidates_indices]
