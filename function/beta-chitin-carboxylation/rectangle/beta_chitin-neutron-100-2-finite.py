        ...
        for index_ranges in indices_lists:
            for start_idx, end_idx in index_ranges:
                ...
                for residue in residues:
                    ...
                    if residue.resid % 2 == 1  and fragment_number in planes_100_upper:  # Odd residue ID
                        coo_new_positions = {
                            'O61': base_atom.position + np.array([ 1.345,  -0.473,  -0.114]),
                            'O62': base_atom.position + np.array([-1.093,  -0.896,  -0.216])
                        }
                    elif residue.resid % 2 == 0  and fragment_number in planes_100_upper:  # Even residue ID
                        coo_new_positions = {
                            'O61': base_atom.position + np.array([ 1.093,   0.896,  -0.216]),
                            'O62': base_atom.position + np.array([-1.345,   0.473,  -0.114])
                        }
    
                    elif residue.resid % 2 == 1  and fragment_number in planes_100_bottom:  # Odd residue ID
                        coo_new_positions = {
                            'O61': base_atom.position + np.array([ 1.345,  -0.473,  -0.114]),
                            'O62': base_atom.position + np.array([-1.093,  -0.896,  -0.216])
                        }
                    elif residue.resid % 2 == 0  and fragment_number in planes_100_bottom:  # Even residue ID
                        coo_new_positions = {
                            'O61': base_atom.position + np.array([ 1.093,   0.896,  -0.216]),
                            'O62': base_atom.position + np.array([-1.345,   0.473,  -0.114])
                        }
