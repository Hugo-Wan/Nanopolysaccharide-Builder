...
if sulfate_num > 0:
    ...
    new_sulfate_number_update=left_010_count_update + right_010_count_update + left_100_count_update + right_100_count_update 
    ...
    all_indices = [left_010_so3_candidates_indices, right_010_so3_candidates_indices, left_100_so3_candidates_indices, right_100_so3_candidates_indices]
