...
try:
    ...
    sys.stderr.write("Error: Missing one or more input arguments. Please provide one integer values for c parameter.\n")
    sys.exit(1)
...
with mda.Writer("glycam06-cellulose-Ibeta-18icm.pdb", n_atoms=u_final.atoms.n_atoms, reindex=True) as W:
