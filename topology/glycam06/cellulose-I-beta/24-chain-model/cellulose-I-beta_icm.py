...
structure_input_file = os.path.join(main_folder_path, 'glycam06-cellulose-Ibeta-24icm.pdb')
...
def generate_tleap_combine_command(num_glycans):
    ...
    output_lines.extend([
        "\nsaveAmberParm combined_glycan glycam06-cellulose-Ibeta-24icm.prmtop glycam06-cellulose-Ibeta-24icm.inpcrd",
        "quit"
    ])
