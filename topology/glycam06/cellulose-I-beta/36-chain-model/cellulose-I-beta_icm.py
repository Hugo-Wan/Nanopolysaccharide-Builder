...
structure_input_file = os.path.join(main_folder_path, 'glycam06-cellulose-Ibeta-36icm.pdb')
...
def generate_tleap_combine_command(num_glycans):
    ...
    output_lines.extend([
        "\nsaveAmberParm combined_glycan glycam06-cellulose-Ibeta-36icm.prmtop glycam06-cellulose-Ibeta-36icm.inpcrd",
        "quit"
    ])
