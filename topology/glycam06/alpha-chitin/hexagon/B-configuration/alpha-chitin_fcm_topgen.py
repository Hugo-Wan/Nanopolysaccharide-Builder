...
structure_input_file = os.path.join(main_folder_path, 'glycam06-alpha-chitin-B-hexagon-fcm.pdb')
...
def generate_tleap_combine_command(num_glycans, block_size=50):
    ...
    output_lines.extend([
        "",
        "saveAmberParm combined_final glycam06-alpha-chitin-B-hexagon-fcm.prmtop glycam06-alpha-chitin-B-hexagon-fcm.inpcrd",
        "quit"
    ])
