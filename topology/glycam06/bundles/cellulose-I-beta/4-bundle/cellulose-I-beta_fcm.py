...
structure_input_file = os.path.join(main_folder_path, 'glycam06-c1b-4-bundles-fcm.pdb')
...
def generate_tleap_combine_command(num_glycans, block_size=95):
    ...
    output_lines.extend([
        "",
        "saveAmberParm combined_final glycam06-c1b-4-bundles-fcm.prmtop glycam06-c1b-4-bundles-fcm.inpcrd",
        "quit"
    ])
