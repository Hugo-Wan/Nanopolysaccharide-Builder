...
structure_input_file = os.path.join(main_folder_path, 'charmm36-cellulose-Ibeta-18icm.pdb')
...
gen.write_psf(filename=os.path.join(main_folder_path, "charmm36-cellulose-Ibeta-18icm.psf"))
