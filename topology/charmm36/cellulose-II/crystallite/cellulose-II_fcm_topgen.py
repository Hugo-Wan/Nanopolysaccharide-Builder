...
structure_input_file = os.path.join(main_folder_path, 'charmm36-cellulose-II-fcm.pdb')
...
for i in range(0, num_fragment):
    ...
    selected_fragment.write(f"celluloseII_temp_{j}.pdb") 
    input_pdb = os.path.join(main_folder_path, f'celluloseII_temp_{j}.pdb')
...
gen.write_psf(filename=os.path.join(main_folder_path, "charmm36-cellulose-II-fcm.psf"))
