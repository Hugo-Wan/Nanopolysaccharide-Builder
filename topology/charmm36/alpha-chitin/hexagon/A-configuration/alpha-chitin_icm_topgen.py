...
structure_input_file = os.path.join(main_folder_path, 'charmm36-alpha-chitin-A-hexagon-icm.pdb')
...
gen.write_psf(filename=os.path.join(main_folder_path, "charmm36-alpha-chitin-A-hexagon-icm.psf"))
