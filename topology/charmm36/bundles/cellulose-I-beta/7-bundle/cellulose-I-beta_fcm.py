...
structure_input_file = os.path.join(main_folder_path, 'charmm36-c1b-7-bundles-fcm.pdb')
...
gen.write_psf(filename=os.path.join(main_folder_path, "charmm36-c1b-7-bundles-fcm.psf"))
