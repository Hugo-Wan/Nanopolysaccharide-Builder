...
structure_input_file = os.path.join(main_folder_path, 'glycam06-cellulose-II-fcm.pdb')
...
def generate_tleap_combine_command(num_glycans):
    ...
    output_lines.extend([
        "\nsaveAmberParm combined_glycan glycam06-cellulose-II-fcm.prmtop glycam06-cellulose-II-fcm.inpcrd",
        "quit"
    ])
